    ...
    build: function(options) {
      ...
      if (self.options.typeaheadjs) {
        ...
        $.fn.typeahead.apply(self.$input, typeaheadjs).on('typeahead:selected', $.proxy(function (obj, datum, name) {
          ...
          console.log(datum);
            console.log(name);
            console.log(typeaheadjs);
          typeaheadjs.some(function(dataset, _index) {
            console.log(dataset)
            console.log(_index)
            // TC: added first 3 lines to skip null 
            if (dataset == null){
              return false;
            }
            else if (dataset.name === name) {
              index = _index;
              return true;
            }
            return false;
          ...
          // TC: Hack: Added first 3 lines to bypass the check
          if (typeaheadjs[index] == null){
            self.add(datum);
          }
          else if (typeaheadjs[index].valueKey) {
